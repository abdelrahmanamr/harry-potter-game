...
public class SecondTask extends Task {
	...
	public void moveForward() throws IOException, OutOfBordersException,
		...
		if (next instanceof TreasureCell
			...
			JOptionPane.showMessageDialog(null, current.getName() +"has qualified to the third task.");
			endTurn();
	...
	public void encounterMerPerson() {
		...
		if (currentX + 1 <= 9
			...
			JOptionPane.showMessageDialog(null, "A merperson ATTACKED! "+ ((Merperson) (cell.getObstacle())).getDamage() + " DAMAGE WAS DONE","ATTACK", 0, new ImageIcon("src/Merperson1.png"));
	...
	}public static void MerpersonEffect(){
		try {
		    File yourFile;
		    ...
		    DataLine.Info info;
		    Clip clip;
	        yourFile = new File("src/Monster.wav");
